...
import com.parallel.pages.DataTablePage;
...
public class ScenarioOutlineExampleSteps {
    ...
    public void user_is_on_the_datatables_homepage() {
        Driver.get().get("https://editor.datatables.net/");
    ...
    public void user_enters_first_name() {
        dataTablePage.firstName.sendKeys("Osman");
    }

    @When("User enters last name")
    public void user_enters_last_name() {
       dataTablePage.lastName.sendKeys("Nedim");
    }

    @When("User enters position")
    public void user_enters_position() {
        dataTablePage.position.sendKeys("sdat");
    }
    ...
    public void user_enters_extension() {
        dataTablePage.extension.sendKeys("yeni");
    }

    @When("User enters start date")
    public void user_enters_start_date() {
        dataTablePage.startDate.sendKeys("2020-12-12");
    }
